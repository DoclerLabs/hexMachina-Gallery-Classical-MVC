...
$hxClasses["example.FlickrExample"] = example_FlickrExample;
example_FlickrExample.__name__ = ["example","FlickrExample"];
example_FlickrExample.main = function() {
	...
	example_FlickrExample.self = new example_FlickrExample();
};
example_FlickrExample.prototype = {
	_getApplicationXml: function() {
		return Xml.parse("<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n<root name=\"flickr\">\n\t\t<!-- MODULES -->\n\t<module id=\"gallery\" type=\"example.module.gallery.GalleryModule\">\n\t\t<argument ref=\"flickerServiceLocator\"/>\n\t</module>\n\t\n\n\t\t<serviceLocator id=\"flickerServiceLocator\" type=\"hex.config.stateful.ServiceLocator\" >\n\t\t<item> \n\t\t\t<key type=\"Class\" value=\"example.module.gallery.service.IGetPhotosService\"/>\n\t\t\t<value type=\"Class\" value=\"example.service.flickr.FlickrGetPhotos\"/>\n\t\t</item>\n\t</serviceLocator>\n\n\t\n\t\t\n\n</root>");
	}
	,_build: function(xml) {
		var applicationAssembler = new hex_ioc_assembler_ApplicationAssembler();
		new hex_ioc_parser_xml_ApplicationXMLParser().parse(applicationAssembler,xml);
		applicationAssembler.buildEverything();
	}
	,__class__: example_FlickrExample
};
...
hex_module_Module.prototype = {
	...
	,initialize: function() {
		if(!this.get_isInitialized()) {
			...
			throw new js__$Boot_HaxeError(new hex_error_IllegalStateException(Std.string(this) + ".initialize can't be called more than once. Check your code.",{ fileName : "Module.hx", lineNumber : 78, className : "hex.module.Module", methodName : "initialize"}));
		}
	}
	,isInitialized: null
...
var example_module_gallery_IGalleryModule = function() { };
$hxClasses["example.module.gallery.IGalleryModule"] = example_module_gallery_IGalleryModule;
example_module_gallery_IGalleryModule.__name__ = ["example","module","gallery","IGalleryModule"];
example_module_gallery_IGalleryModule.__interfaces__ = [hex_module_IModule];
var example_module_gallery_GalleryModule = function(serviceConfig) {
	hex_module_Module.call(this);
	this.getLogger().debug("Hello",{ fileName : "GalleryModule.hx", lineNumber : 25, className : "example.module.gallery.GalleryModule", methodName : "new"});
	this._addStatefulConfigs([serviceConfig]);
	this._addStatelessConfigClasses([example_module_gallery__$GalleryModule_GalleryCommandConfig,example_module_gallery__$GalleryModule_GalleryModelConfig]);
	this.buildView();
	this._dispatchPrivateMessage(example_module_gallery_message_GalleryModuleMessage.LOAD_PHOTOS);
};
$hxClasses["example.module.gallery.GalleryModule"] = example_module_gallery_GalleryModule;
example_module_gallery_GalleryModule.__name__ = ["example","module","gallery","GalleryModule"];
example_module_gallery_GalleryModule.__interfaces__ = [example_module_gallery_IGalleryModule];
example_module_gallery_GalleryModule.__super__ = hex_module_Module;
example_module_gallery_GalleryModule.prototype = $extend(hex_module_Module.prototype,{
	_getRuntimeDependencies: function() {
		return new hex_module_dependency_RuntimeDependencies();
	}
	,buildView: function() {
		this.buildViewHelper(example_module_gallery_view_GalleryViewHelper,new example_module_gallery_view_GalleryViewJS(window.document.querySelector(".gallery")));
	}
	,__class__: example_module_gallery_GalleryModule
});
...
var example_module_gallery__$GalleryModule_GalleryCommandConfig = function() {
	hex_config_stateless_StatelessCommandConfig.call(this);
};
$hxClasses["example.module.gallery._GalleryModule.GalleryCommandConfig"] = example_module_gallery__$GalleryModule_GalleryCommandConfig;
example_module_gallery__$GalleryModule_GalleryCommandConfig.__name__ = ["example","module","gallery","_GalleryModule","GalleryCommandConfig"];
example_module_gallery__$GalleryModule_GalleryCommandConfig.__super__ = hex_config_stateless_StatelessCommandConfig;
example_module_gallery__$GalleryModule_GalleryCommandConfig.prototype = $extend(hex_config_stateless_StatelessCommandConfig.prototype,{
	configure: function() {
		this.map(example_module_gallery_message_GalleryModuleMessage.LOAD_PHOTOS,example_module_gallery_controller_LoadPhotosCommand);
	}
	,__class__: example_module_gallery__$GalleryModule_GalleryCommandConfig
});
...
var example_module_gallery__$GalleryModule_GalleryModelConfig = function() {
	hex_config_stateless_StatelessModelConfig.call(this);
};
$hxClasses["example.module.gallery._GalleryModule.GalleryModelConfig"] = example_module_gallery__$GalleryModule_GalleryModelConfig;
example_module_gallery__$GalleryModule_GalleryModelConfig.__name__ = ["example","module","gallery","_GalleryModule","GalleryModelConfig"];
example_module_gallery__$GalleryModule_GalleryModelConfig.__super__ = hex_config_stateless_StatelessModelConfig;
example_module_gallery__$GalleryModule_GalleryModelConfig.prototype = $extend(hex_config_stateless_StatelessModelConfig.prototype,{
	configure: function() {
		this.mapModel(example_module_gallery_model_IGalleryModel,example_module_gallery_model_GalleryModel);
	}
	,__class__: example_module_gallery__$GalleryModule_GalleryModelConfig
});
...
var example_module_gallery_controller_LoadPhotosCommand = function() {
	hex_control_command_BasicCommand.call(this);
};
$hxClasses["example.module.gallery.controller.LoadPhotosCommand"] = example_module_gallery_controller_LoadPhotosCommand;
example_module_gallery_controller_LoadPhotosCommand.__name__ = ["example","module","gallery","controller","LoadPhotosCommand"];
example_module_gallery_controller_LoadPhotosCommand.__interfaces__ = [hex_service_stateless_http_IHTTPServiceListener];
example_module_gallery_controller_LoadPhotosCommand.__super__ = hex_control_command_BasicCommand;
example_module_gallery_controller_LoadPhotosCommand.prototype = $extend(hex_control_command_BasicCommand.prototype,{
	photosService: null
	,galleryModel: null
	,execute: function(request) {
		this.getLogger().debug("LoadPhotosCommand execute",{ fileName : "LoadPhotosCommand.hx", lineNumber : 33, className : "example.module.gallery.controller.LoadPhotosCommand", methodName : "execute"});
		this.photosService.addHTTPServiceListener(this);
		this.photosService.call();
	}
	,onServiceComplete: function(service) {
		this.getLogger().debug(this.galleryModel,{ fileName : "LoadPhotosCommand.hx", lineNumber : 41, className : "example.module.gallery.controller.LoadPhotosCommand", methodName : "onServiceComplete"});
		this.galleryModel.setPhotos((js_Boot.__cast(service , example_module_gallery_service_IGetPhotosService)).getPhotos());
	}
	,onServiceFail: function(service) {
		this.getLogger().error("onServiceFail",{ fileName : "LoadPhotosCommand.hx", lineNumber : 47, className : "example.module.gallery.controller.LoadPhotosCommand", methodName : "onServiceFail"});
	}
	,onServiceCancel: function(service) {
		this.getLogger().warn("onServiceCancel",{ fileName : "LoadPhotosCommand.hx", lineNumber : 51, className : "example.module.gallery.controller.LoadPhotosCommand", methodName : "onServiceCancel"});
	}
	,onServiceTimeout: function(service) {
		this.getLogger().warn("onServiceTimeout",{ fileName : "LoadPhotosCommand.hx", lineNumber : 55, className : "example.module.gallery.controller.LoadPhotosCommand", methodName : "onServiceTimeout"});
	}
	,__class__: example_module_gallery_controller_LoadPhotosCommand
});
...
var example_module_gallery_message_GalleryModuleMessage = function() { };
$hxClasses["example.module.gallery.message.GalleryModuleMessage"] = example_module_gallery_message_GalleryModuleMessage;
example_module_gallery_message_GalleryModuleMessage.__name__ = ["example","module","gallery","message","GalleryModuleMessage"];
...
var example_module_gallery_model_IGalleryModelRO = function() { };
$hxClasses["example.module.gallery.model.IGalleryModelRO"] = example_module_gallery_model_IGalleryModelRO;
example_module_gallery_model_IGalleryModelRO.__name__ = ["example","module","gallery","model","IGalleryModelRO"];
example_module_gallery_model_IGalleryModelRO.__interfaces__ = [hex_model_IModelRO];
example_module_gallery_model_IGalleryModelRO.prototype = {
	getPhotos: null
	,__class__: example_module_gallery_model_IGalleryModelRO
};
var example_module_gallery_model_IGalleryModel = function() { };
$hxClasses["example.module.gallery.model.IGalleryModel"] = example_module_gallery_model_IGalleryModel;
example_module_gallery_model_IGalleryModel.__name__ = ["example","module","gallery","model","IGalleryModel"];
example_module_gallery_model_IGalleryModel.__interfaces__ = [example_module_gallery_model_IGalleryModelRO];
example_module_gallery_model_IGalleryModel.prototype = {
	setPhotos: null
	,__class__: example_module_gallery_model_IGalleryModel
};
var example_module_gallery_model_GalleryModel = function() {
	this.dispatcher = new example_module_gallery_model_GalleryModelDispatcher();
};
$hxClasses["example.module.gallery.model.GalleryModel"] = example_module_gallery_model_GalleryModel;
example_module_gallery_model_GalleryModel.__name__ = ["example","module","gallery","model","GalleryModel"];
example_module_gallery_model_GalleryModel.__interfaces__ = [example_module_gallery_model_IGalleryModel];
example_module_gallery_model_GalleryModel.prototype = {
	_photos: null
	,dispatcher: null
	...
	,__class__: example_module_gallery_model_GalleryModel
};
...
var example_module_gallery_model_IGalleryModelListener = function() { };
$hxClasses["example.module.gallery.model.IGalleryModelListener"] = example_module_gallery_model_IGalleryModelListener;
example_module_gallery_model_IGalleryModelListener.__name__ = ["example","module","gallery","model","IGalleryModelListener"];
example_module_gallery_model_IGalleryModelListener.__interfaces__ = [hex_model_IModelListener];
example_module_gallery_model_IGalleryModelListener.prototype = {
	onPhotosLoaded: null
	,__class__: example_module_gallery_model_IGalleryModelListener
};
var example_module_gallery_model_GalleryModelDispatcher = function() {
	hex_model_ModelDispatcher.call(this);
};
$hxClasses["example.module.gallery.model.GalleryModelDispatcher"] = example_module_gallery_model_GalleryModelDispatcher;
example_module_gallery_model_GalleryModelDispatcher.__name__ = ["example","module","gallery","model","GalleryModelDispatcher"];
example_module_gallery_model_GalleryModelDispatcher.__interfaces__ = [example_module_gallery_model_IGalleryModelListener];
example_module_gallery_model_GalleryModelDispatcher.__super__ = hex_model_ModelDispatcher;
example_module_gallery_model_GalleryModelDispatcher.prototype = $extend(hex_model_ModelDispatcher.prototype,{
	onPhotosLoaded: function(photos) {
		var _g = 0;
	...
	,__class__: example_module_gallery_model_GalleryModelDispatcher
});
...
var example_module_gallery_service_IGetPhotosService = function() { };
$hxClasses["example.module.gallery.service.IGetPhotosService"] = example_module_gallery_service_IGetPhotosService;
example_module_gallery_service_IGetPhotosService.__name__ = ["example","module","gallery","service","IGetPhotosService"];
example_module_gallery_service_IGetPhotosService.__interfaces__ = [hex_service_stateless_http_IHTTPService];
example_module_gallery_service_IGetPhotosService.prototype = {
	getPhotos: null
	,__class__: example_module_gallery_service_IGetPhotosService
};
...
var example_module_gallery_view_GalleryViewHelper = function() {
	hex_view_viewhelper_ViewHelper.call(this);
};
$hxClasses["example.module.gallery.view.GalleryViewHelper"] = example_module_gallery_view_GalleryViewHelper;
example_module_gallery_view_GalleryViewHelper.__name__ = ["example","module","gallery","view","GalleryViewHelper"];
example_module_gallery_view_GalleryViewHelper.__interfaces__ = [example_module_gallery_model_IGalleryModelListener];
example_module_gallery_view_GalleryViewHelper.__super__ = hex_view_viewhelper_ViewHelper;
example_module_gallery_view_GalleryViewHelper.prototype = $extend(hex_view_viewhelper_ViewHelper.prototype,{
	_layoutView: null
	,_model: null
	,_initialize: function() {
		hex_view_viewhelper_ViewHelper.prototype._initialize.call(this);
		this._layoutView = this._view;
		this.getLogger().debug(this._layoutView,{ fileName : "GalleryViewHelper.hx", lineNumber : 30, className : "example.module.gallery.view.GalleryViewHelper", methodName : "_initialize"});
		this._model.addListener(this);
	}
	,onPhotosLoaded: function(photos) {
		this._layoutView.setPhotos(photos);
	}
	,__class__: example_module_gallery_view_GalleryViewHelper
});
...
var example_module_gallery_view_IGalleryView = function() { };
$hxClasses["example.module.gallery.view.IGalleryView"] = example_module_gallery_view_IGalleryView;
example_module_gallery_view_IGalleryView.__name__ = ["example","module","gallery","view","IGalleryView"];
example_module_gallery_view_IGalleryView.__interfaces__ = [hex_view_IView];
example_module_gallery_view_IGalleryView.prototype = {
	setPhotos: null
	,__class__: example_module_gallery_view_IGalleryView
};
var example_module_gallery_view_GalleryViewJS = function(layout) {
	this._layout = layout;
};
$hxClasses["example.module.gallery.view.GalleryViewJS"] = example_module_gallery_view_GalleryViewJS;
example_module_gallery_view_GalleryViewJS.__name__ = ["example","module","gallery","view","GalleryViewJS"];
example_module_gallery_view_GalleryViewJS.__interfaces__ = [example_module_gallery_view_IGalleryView];
example_module_gallery_view_GalleryViewJS.prototype = {
	...
	,__class__: example_module_gallery_view_GalleryViewJS
	,__properties__: {set_visible:"set_visible",get_visible:"get_visible"}
};
var example_module_gallery_vo_PhotoVO = function(url,name) {
	if(name == null) {
		name = "";
	}
	this.url = url;
...
$hxClasses["example.module.gallery.vo.PhotoVO"] = example_module_gallery_vo_PhotoVO;
example_module_gallery_vo_PhotoVO.__name__ = ["example","module","gallery","vo","PhotoVO"];
example_module_gallery_vo_PhotoVO.prototype = {
	url: null
	,name: null
	,__class__: example_module_gallery_vo_PhotoVO
};
...
hex_service_stateless_StatelessService.prototype = $extend(hex_service_AbstractService.prototype,{
	...
	,setConfiguration: function(configuration) {
		if(this.get_wasUsed()) {
			throw new js__$Boot_HaxeError(new hex_error_IllegalStateException("'setConfiguration' can't be called after service call @" + hex_log_Stringifier.stringify(this),{ fileName : "StatelessService.hx", lineNumber : 45, className : "hex.service.stateless.StatelessService", methodName : "setConfiguration"}));
		} else {
...
var example_service_flickr_FlickrGetPhotos = function() {
	hex_service_stateless_http_HTTPService.call(this);
	hex_log_Logger.DEBUG("FlickrGetPhotos constructor",null,{ fileName : "FlickrGetPhotos.hx", lineNumber : 20, className : "example.service.flickr.FlickrGetPhotos", methodName : "new"});
};
$hxClasses["example.service.flickr.FlickrGetPhotos"] = example_service_flickr_FlickrGetPhotos;
example_service_flickr_FlickrGetPhotos.__name__ = ["example","service","flickr","FlickrGetPhotos"];
example_service_flickr_FlickrGetPhotos.__interfaces__ = [example_module_gallery_service_IGetPhotosService];
example_service_flickr_FlickrGetPhotos.__super__ = hex_service_stateless_http_HTTPService;
example_service_flickr_FlickrGetPhotos.prototype = $extend(hex_service_stateless_http_HTTPService.prototype,{
	createConfiguration: function() {
		hex_log_Logger.DEBUG("FlickrGetPhotos createConfiguration",null,{ fileName : "FlickrGetPhotos.hx", lineNumber : 29, className : "example.service.flickr.FlickrGetPhotos", methodName : "createConfiguration"});
		this.setConfiguration(new hex_service_stateless_http_HTTPServiceConfiguration("https://api.flickr.com/services/rest/?method=flickr.people.getPublicPhotos&api_key=bdeda660a5fcdf79170c711c07156f12&user_id=134406781%40N06&format=json"));
		this.setParser(new example_service_flickr_FlickrPhotosParser());
	}
	,getPhotos: function() {
		return this._result;
	}
	,__class__: example_service_flickr_FlickrGetPhotos
});
var example_service_flickr_FlickrPhotosParser = function() {
};
$hxClasses["example.service.flickr.FlickrPhotosParser"] = example_service_flickr_FlickrPhotosParser;
example_service_flickr_FlickrPhotosParser.__name__ = ["example","service","flickr","FlickrPhotosParser"];
example_service_flickr_FlickrPhotosParser.prototype = {
	parse: function(serializedContent) {
		hex_log_Logger.DEBUG("parse",null,{ fileName : "FlickrPhotosParser.hx", lineNumber : 23, className : "example.service.flickr.FlickrPhotosParser", methodName : "parse"});
		...
		hex_log_Logger.DEBUG(jsonString,null,{ fileName : "FlickrPhotosParser.hx", lineNumber : 28, className : "example.service.flickr.FlickrPhotosParser", methodName : "parse"});
		var photosList = [];
		var _g = 0;
		...
		while(_g < _g1.length) {
			...
			photosList.push(new example_module_gallery_vo_PhotoVO("https://farm" + photo.farm + ".staticflickr.com/" + photo.server + "/" + photo.id + "_" + photo.secret + "_b.jpg",photo.title));
		}
		return photosList;
	}
	,__class__: example_service_flickr_FlickrPhotosParser
};
...
hex_collection_Locator.prototype = {
	...
	,locate: function(key) {
		if(this.isRegisteredWithKey(key)) {
			...
			throw new js__$Boot_HaxeError(new hex_error_NoSuchElementException("Can't find item with '" + Std.string(key) + "' key in " + this.toString(),{ fileName : "Locator.hx", lineNumber : 69, className : "hex.collection.Locator", methodName : "locate"}));
		}
	}
	,add: function(m) {
		var iterator = m.keys();
	...
	,register: function(key,element) {
		if(this._map.containsKey(key)) {
			throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException("item is already registered with '" + Std.string(key) + "' key in " + this.toString(),{ fileName : "Locator.hx", lineNumber : 88, className : "hex.collection.Locator", methodName : "register"}));
		} else {
...
hex_compiler_parser_xml_XmlContextReader.updateParentSize = function(xrd,lengthOffset,includeLengthOffset) {
	...
	if(parent.parent != null) {
		hex_compiler_parser_xml_XmlContextReader.updateParentSize(parent,lengthOffset,includeLengthOffset);
	}
};
hex_compiler_parser_xml_XmlContextReader.updateChildPosition = function(xrd,offset) {
	...
	while(_g < _g1.length) {
		...
		if(child.children.length > 0) {
			hex_compiler_parser_xml_XmlContextReader.updateChildPosition(child,offset);
		}
	}
};
...
hex_di_Injector.prototype = {
	...
	,unmap: function(type,name) {
		...
		var mapping = __map_reserved[mappingID] != null?_this.getReserved(mappingID):_this.h[mappingID];
		if(mapping == null) {
			throw new js__$Boot_HaxeError(new hex_di_error_InjectorException("unmap failed with mapping named '" + mappingID + "' @" + hex_log_Stringifier.stringify(this),{ fileName : "Injector.hx", lineNumber : 164, className : "hex.di.Injector", methodName : "unmap"}));
		}
	...
	,hasDirectMapping: function(type,name) {
		...
		var mappingID = Type.getClassName(type) + "|" + name;
		var _this = this._mapping;
		return (__map_reserved[mappingID] != null?_this.getReserved(mappingID):_this.h[mappingID]) != null;
	}
	...
	,_createMapping: function(type,name,mappingID) {
		...
		if(__map_reserved[mappingID] != null?_this.getReserved(mappingID):_this.h[mappingID]) {
			throw new js__$Boot_HaxeError(new hex_di_error_InjectorException("Mapping named '" + mappingID + "' is already processing @" + hex_log_Stringifier.stringify(this),{ fileName : "Injector.hx", lineNumber : 273, className : "hex.di.Injector", methodName : "_createMapping"}));
		}
	...
	,getCallbackAdapter: function() {
		...
		return Reflect.makeVarArgs(function(rest) {
			...
			if(isEventAdapterStrategyMacro) {
				...
				if(adapterMethodName == "adapt") {
					result = adapterInstance.adapt.apply(adapterInstance,rest);
				} else {
...
hex_ioc_assembler_ApplicationAssembler.prototype = {
	...
	,addConditionalProperty: function(conditionalProperties) {
		...
		while(i.hasNext()) {
			...
			if(!(__map_reserved[key] != null?_this.existsReserved(key):_this.h.hasOwnProperty(key))) {
				...
				throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException("addConditionalcontext fails with key'" + key + "', this key was already assigned",{ fileName : "ApplicationAssembler.hx", lineNumber : 58, className : "hex.ioc.assembler.ApplicationAssembler", methodName : "addConditionalProperty"}));
			}
		}
	}
		...
		if(ifList != null) {
			...
			while(_g < ifList.length) {
				...
				if(__map_reserved[ifItem] != null?_this.existsReserved(ifItem):_this.h.hasOwnProperty(ifItem)) {
					...
					throw new js__$Boot_HaxeError(new hex_ioc_error_BuildingException("'" + ifItem + "' was not found in application assembler",{ fileName : "ApplicationAssembler.hx", lineNumber : 78, className : "hex.ioc.assembler.ApplicationAssembler", methodName : "allowsIfList"}));
				}
			}
		} else {
			return true;
		...
		if(ifNotList != null) {
			...
			while(_g < ifNotList.length) {
				...
				if(__map_reserved[ifNotItem] != null?_this.existsReserved(ifNotItem):_this.h.hasOwnProperty(ifNotItem)) {
					...
					throw new js__$Boot_HaxeError(new hex_ioc_error_BuildingException("'" + ifNotItem + "' was not found in application assembler",{ fileName : "ApplicationAssembler.hx", lineNumber : 105, className : "hex.ioc.assembler.ApplicationAssembler", methodName : "allowsIfNotList"}));
				}
			}
		}
		return true;
	...
	,buildProperty: function(applicationContext,ownerID,name,value,type,ref,method,staticRef,ifList,ifNotList) {
		if(this.allowsIfList(ifList) && this.allowsIfNotList(ifNotList)) {
			this.getContextFactory(applicationContext).registerPropertyVO(ownerID,new hex_ioc_vo_PropertyVO(ownerID,name,value,type,ref,method,staticRef));
		}
	}
	,buildObject: function(applicationContext,ownerID,type,args,factory,singleton,injectInto,mapType,staticRef,ifList,ifNotList) {
		...
		if(this.allowsIfList(ifList) && this.allowsIfNotList(ifNotList)) {
			...
			this.getContextFactory(applicationContext).registerConstructorVO(ownerID,new hex_ioc_vo_ConstructorVO(ownerID,type,args,factory,singleton,injectInto,null,mapType,staticRef));
		}
	}
	,buildMethodCall: function(applicationContext,ownerID,methodCallName,args,ifList,ifNotList) {
		if(this.allowsIfList(ifList) && this.allowsIfNotList(ifNotList)) {
			this.getContextFactory(applicationContext).registerMethodCallVO(new hex_ioc_vo_MethodCallVO(ownerID,methodCallName,args));
		}
	}
	,buildDomainListener: function(applicationContext,ownerID,listenedDomainName,args,ifList,ifNotList) {
		if(this.allowsIfList(ifList) && this.allowsIfNotList(ifNotList)) {
			this.getContextFactory(applicationContext).registerDomainListenerVO(new hex_ioc_vo_DomainListenerVO(ownerID,listenedDomainName,args));
		}
	}
	,configureStateTransition: function(applicationContext,ownerID,staticReference,instanceReference,enterList,exitList,ifList,ifNotList) {
		if(this.allowsIfList(ifList) && this.allowsIfNotList(ifNotList)) {
			this._registerID(applicationContext,ownerID);
			this.getContextFactory(applicationContext).registerStateTransitionVO(ownerID,new hex_ioc_vo_StateTransitionVO(ownerID,staticReference,instanceReference,enterList,exitList));
		}
	}
	,buildEverything: function() {
		...
		var _g2 = 0;
		while(_g2 < applicationContexts.length) {
			var applicationcontext1 = applicationContexts[_g2];
			++_g2;
...
hex_ioc_control_DomainListenerFactory.build = function(id,domainListenerVOLocator,applicationContext,annotationProvider) {
	...
	if(coreFactory.isRegisteredWithKey(domainListener.listenedDomainName)) {
		...
		if(js_Boot.__instanceof(located,hex_service_IService)) {
			service = located;
		}
	}
	if(args != null && args.length > 0) {
...
hex_ioc_control_DomainListenerFactory._getStrategyCallback = function(annotationProvider,applicationContext,listener,method,strategyClassName,injectedInModule) {
	...
	if(injectedInModule && js_Boot.__instanceof(listener,hex_module_IModule)) {
		...
		adapter.setFactoryMethod(applicationContext.getBasicInjector(),($_=applicationContext.getBasicInjector(),$bind($_,$_.instantiateUnmapped)));
	}
	return Reflect.makeVarArgs(function(rest) {
...
hex_ioc_control_HashMapFactory.build = function(factoryVO) {
	...
	if(constructorVO.mapType != null) {
		factoryVO.contextFactory.getApplicationContext().getBasicInjector().mapToValue(hex_collection_HashMap,constructorVO.result,constructorVO.ID);
	}
};
...
hex_ioc_control_UIntFactory.build = function(factoryVO) {
	...
	if(args != null && args.length > 0) {
		...
		throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException("UIntFactory.build(" + (args != null && args.length > 0?args[0]:"") + ") failed.",{ fileName : "UIntFactory.hx", lineNumber : 31, className : "hex.ioc.control.UIntFactory", methodName : "build"}));
	}
	if(number == null || _$UInt_UInt_$Impl_$.gt(0,number)) {
		throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException("UIntFactory.build(" + Std.string(_$UInt_UInt_$Impl_$.toFloat(number)) + ") failed.",{ fileName : "UIntFactory.hx", lineNumber : 40, className : "hex.ioc.control.UIntFactory", methodName : "build"}));
	} else {
		constructorVO.result = number;
	}
};
...
hex_ioc_core_CoreFactory.prototype = {
	...
	,register: function(key,element) {
		...
		if(!(__map_reserved[key] != null?_this.existsReserved(key):_this.h.hasOwnProperty(key))) {
			...
			throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException("register(" + key + ", " + Std.string(element) + ") fails, key is already registered.",{ fileName : "CoreFactory.hx", lineNumber : 104, className : "hex.ioc.core.CoreFactory", methodName : "register"}));
		}
	}
		...
		if(instantiateUnmapped) {
			...
			if(singletonAccess != null) {
				...
				if(singletonCall != null) {
					...
					throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException(qualifiedClassName + "." + singletonAccess + "()' singleton access failed.",{ fileName : "CoreFactory.hx", lineNumber : 195, className : "hex.ioc.core.CoreFactory", methodName : "buildInstance"}));
				}
				var methodReference = Reflect.field(inst,factoryMethod);
				if(methodReference != null) {
					obj = methodReference.apply(inst,args);
				} else {
					throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException(qualifiedClassName + "." + singletonAccess + "()." + factoryMethod + "()' factory method call failed.",{ fileName : "CoreFactory.hx", lineNumber : 205, className : "hex.ioc.core.CoreFactory", methodName : "buildInstance"}));
				}
			} else {
				...
				if(methodReference1 != null) {
					...
					throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException(qualifiedClassName + "." + factoryMethod + "()' factory method call failed.",{ fileName : "CoreFactory.hx", lineNumber : 218, className : "hex.ioc.core.CoreFactory", methodName : "buildInstance"}));
				}
			}
			...
			if(singletonCall1 != null) {
				...
				throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException(qualifiedClassName + "." + singletonAccess + "()' singleton call failed.",{ fileName : "CoreFactory.hx", lineNumber : 231, className : "hex.ioc.core.CoreFactory", methodName : "buildInstance"}));
			}
		} else {
			try {
	...
	,buildStateTransition: function(key) {
		if(this.isRegisteredWithKey(key)) {
			...
			if(vo.staticReference != null) {
				...
				throw new js__$Boot_HaxeError(new hex_ioc_error_BuildingException(Std.string(this) + ".buildStateTransition failed with id '" + key + "'",{ fileName : "StateTransitionVOLocator.hx", lineNumber : 54, className : "hex.ioc.locator.StateTransitionVOLocator", methodName : "buildStateTransition"}));
			}
			...
			if(state == null) {
				throw new js__$Boot_HaxeError(new hex_ioc_error_BuildingException(Std.string(this) + ".buildStateTransition failed with '" + Std.string(vo) + "'",{ fileName : "StateTransitionVOLocator.hx", lineNumber : 70, className : "hex.ioc.locator.StateTransitionVOLocator", methodName : "buildStateTransition"}));
			}
...
hex_ioc_parser_AbstractParserCommand.prototype = $extend(hex_control_async_AsyncCommand.prototype,{
	...
	,execute: function(request) {
		if(this._contextData != null) {
			...
			throw new js__$Boot_HaxeError(new hex_error_NullPointerException(Std.string(this) + ".execute() failed. Context data was null.",{ fileName : "AbstractParserCommand.hx", lineNumber : 33, className : "hex.ioc.parser.AbstractParserCommand", methodName : "execute"}));
		}
	}
...
hex_ioc_parser_xml_AbstractXMLParser.prototype = $extend(hex_ioc_parser_AbstractParserCommand.prototype,{
	getApplicationContext: function(applicationContextClass) {
		...
		if(applicationContextName == null) {
			throw new js__$Boot_HaxeError(new hex_ioc_error_ParsingException(Std.string(this) + " failed to retrieve applicationContext name. You should add 'name' attribute to the root of your xml context",{ fileName : "AbstractXMLParser.hx", lineNumber : 26, className : "hex.ioc.parser.xml.AbstractXMLParser", methodName : "getApplicationContext"}));
		}
	...
	,setContextData: function(data) {
		if(data != null) {
			if(js_Boot.__instanceof(data,Xml)) {
				...
				throw new js__$Boot_HaxeError(new hex_error_IllegalArgumentException(Std.string(this) + ".setContext() failed. Data should be an instance of Xml.",{ fileName : "AbstractXMLParser.hx", lineNumber : 44, className : "hex.ioc.parser.xml.AbstractXMLParser", methodName : "setContextData"}));
			}
		} else {
			throw new js__$Boot_HaxeError(new hex_error_NullPointerException(Std.string(this) + ".setContext() failed. Data was null.",{ fileName : "AbstractXMLParser.hx", lineNumber : 49, className : "hex.ioc.parser.xml.AbstractXMLParser", methodName : "setContextData"}));
		}
	}
...
hex_ioc_parser_xml_ApplicationContextXMLParser.prototype = $extend(hex_ioc_parser_xml_AbstractXMLParser.prototype,{
	parse: function() {
		...
		if(applicationContextClassName != null) {
			try {
				this.getApplicationContext(Type.resolveClass(applicationContextClassName));
			} catch( error ) {
...
var hex_ioc_parser_xml_ApplicationXMLParser = function(parserCollection) {
	if(parserCollection != null) {
		...
		this._parserCollection = new hex_ioc_parser_xml_XMLParserCollection();
	}
};
...
hex_ioc_parser_xml_ApplicationXMLParser.prototype = {
	...
	,parse: function(applicationAssembler,context) {
		if(applicationAssembler != null) {
			...
			throw new js__$Boot_HaxeError(new hex_error_NullPointerException(Std.string(this) + ".parse() can't retrieve instance of ApplicationAssembler",{ fileName : "ApplicationXMLParser.hx", lineNumber : 57, className : "hex.ioc.parser.xml.ApplicationXMLParser", methodName : "parse"}));
		}
		if(context != null) {
			this.setContextData(context);
		} else {
			throw new js__$Boot_HaxeError(new hex_error_NullPointerException(Std.string(this) + ".parse() can't retrieve IoC context data",{ fileName : "ApplicationXMLParser.hx", lineNumber : 66, className : "hex.ioc.parser.xml.ApplicationXMLParser", methodName : "parse"}));
		}
...
hex_ioc_parser_xml_ObjectXMLParser.prototype = $extend(hex_ioc_parser_xml_AbstractXMLParser.prototype,{
	...
	,_parseNode: function(xml) {
		...
		if(identifier == null) {
			var tmp = Std.string(this) + " encounters parsing error with '";
			if(xml.nodeType != Xml.Element) {
				throw new js__$Boot_HaxeError("Bad node type, expected Element but found " + xml.nodeType);
			}
			throw new js__$Boot_HaxeError(new hex_ioc_error_ParsingException(tmp + xml.nodeName + "' node. You must set an id attribute.",{ fileName : "ObjectXMLParser.hx", lineNumber : 41, className : "hex.ioc.parser.xml.ObjectXMLParser", methodName : "_parseNode"}));
		}
		var type;
		var args;
		var factory;
		...
		if(type == "XML") {
			...
			args = [new hex_ioc_vo_ConstructorVO(identifier,"String",[haxe_xml_Printer.print(xml.firstElement())])];
			this.getApplicationAssembler().buildObject(applicationContext,identifier,type,args,factory);
		} else {
			if(type == "hex.collection.HashMap" || type == "hex.config.stateful.ServiceLocator" || type == "hex.ioc.di.MappingConfiguration") {
				args = hex_ioc_parser_xml_XMLParserUtil.getMapArguments(identifier,xml);
			} else {
				args = hex_ioc_parser_xml_XMLParserUtil.getArguments(identifier,xml,type);
			}
			...
			while(propertyIterator.hasNext()) {
				...
				var tmp1 = hex_ioc_parser_xml_XMLAttributeUtil.getName(property);
				var tmp2 = hex_ioc_parser_xml_XMLAttributeUtil.getValue(property);
				var tmp3 = hex_ioc_parser_xml_XMLAttributeUtil.getType(property);
				var tmp4 = hex_ioc_parser_xml_XMLAttributeUtil.getRef(property);
				var tmp5 = hex_ioc_parser_xml_XMLAttributeUtil.getMethod(property);
				var tmp6 = hex_ioc_parser_xml_XMLAttributeUtil.getStaticRef(property);
				var tmp7 = hex_ioc_parser_xml_XMLParserUtil.getIfList(xml);
				var tmp8 = hex_ioc_parser_xml_XMLParserUtil.getIfNotList(xml);
				this.getApplicationAssembler().buildProperty(applicationContext,identifier,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8);
			}
			...
			while(methodCallIterator.hasNext()) {
				...
				var tmp9 = hex_ioc_parser_xml_XMLAttributeUtil.getName(methodCallItem);
				var tmp10 = hex_ioc_parser_xml_XMLParserUtil.getMethodCallArguments(identifier,methodCallItem);
				var tmp11 = hex_ioc_parser_xml_XMLParserUtil.getIfList(methodCallItem);
				var tmp12 = hex_ioc_parser_xml_XMLParserUtil.getIfNotList(methodCallItem);
				this.getApplicationAssembler().buildMethodCall(applicationContext,identifier,tmp9,tmp10,tmp11,tmp12);
			}
			...
			while(listenIterator.hasNext()) {
				...
				if(channelName != null) {
					...
					var tmp13 = hex_ioc_parser_xml_XMLParserUtil.getIfList(listener);
					var tmp14 = hex_ioc_parser_xml_XMLParserUtil.getIfNotList(listener);
					this.getApplicationAssembler().buildDomainListener(applicationContext,identifier,channelName,listenerArgs,tmp13,tmp14);
				} else {
					var tmp15 = Std.string(this) + " encounters parsing error with '";
					if(xml.nodeType != Xml.Element) {
						throw new js__$Boot_HaxeError("Bad node type, expected Element but found " + xml.nodeType);
					}
					throw new js__$Boot_HaxeError(new hex_error_Exception(tmp15 + xml.nodeName + "' node, 'ref' attribute is mandatory in a 'listen' node.",{ fileName : "ObjectXMLParser.hx", lineNumber : 123, className : "hex.ioc.parser.xml.ObjectXMLParser", methodName : "_parseNode"}));
				}
			}
		}
	}
...
hex_ioc_parser_xml_StateXMLParser.prototype = $extend(hex_ioc_parser_xml_AbstractXMLParser.prototype,{
	...
	,_parseNode: function(xml) {
		...
		if(identifier == null) {
			...
			throw new js__$Boot_HaxeError(new hex_ioc_error_ParsingException(tmp + xml.nodeName + "' node. You must set an id attribute.",{ fileName : "StateXMLParser.hx", lineNumber : 41, className : "hex.ioc.parser.xml.StateXMLParser", methodName : "_parseNode"}));
		}
...
hex_ioc_parser_xml_XMLParserUtil.getMapArguments = function(ownerID,xml) {
	...
	while(iterator.hasNext()) {
		...
		if(keyList.hasNext()) {
			args.push(new hex_ioc_vo_MapVO(hex_ioc_parser_xml_XMLParserUtil._getConstructorVO(ownerID,hex_ioc_parser_xml_XMLParserUtil._getAttributes(keyList.next())),hex_ioc_parser_xml_XMLParserUtil._getConstructorVO(ownerID,hex_ioc_parser_xml_XMLParserUtil._getAttributes(valueList.next())),hex_ioc_parser_xml_XMLAttributeUtil.getMapName(item),hex_ioc_parser_xml_XMLAttributeUtil.getAsSingleton(item)));
		}
	}
	return args;
};
...
hex_log_layout_SimpleBrowserLayout.prototype = {
	...
	,_setConsole: function(targetId) {
		...
		if(this._console == null) {
			throw new js__$Boot_HaxeError(new hex_error_NullPointerException("Div named '" + targetId + "' was not found in '" + hex_log_Stringifier.stringify(this) + "'",{ fileName : "SimpleBrowserLayout.hx", lineNumber : 67, className : "hex.log.layout.SimpleBrowserLayout", methodName : "_setConsole"}));
		}
...
example_module_gallery__$GalleryModule_GalleryCommandConfig.__meta__ = { obj : { 'hex.di.IInjectorContainer' : ["{\"ctor\":{\"args\":[],\"isPre\":false,\"name\":\"new\",\"isPost\":false,\"order\":0},\"props\":[{\"isOpt\":false,\"name\":\"frontController\",\"type\":\"hex.control.IFrontController\",\"key\":\"\"}],\"name\":\"example.module.gallery.GalleryModule\",\"methods\":[]}"]}};
...
example_module_gallery__$GalleryModule_GalleryModelConfig.__meta__ = { obj : { 'hex.di.IInjectorContainer' : ["{\"ctor\":{\"args\":[],\"isPre\":false,\"name\":\"new\",\"isPost\":false,\"order\":0},\"props\":[{\"isOpt\":false,\"name\":\"injector\",\"type\":\"hex.di.IDependencyInjector\",\"key\":\"\"}],\"name\":\"example.module.gallery.GalleryModule\",\"methods\":[]}"]}};
example_module_gallery_controller_LoadPhotosCommand.__meta__ = { obj : { 'hex.di.IInjectorContainer' : ["{\"ctor\":{\"args\":[],\"isPre\":false,\"name\":\"new\",\"isPost\":false,\"order\":0},\"props\":[{\"isOpt\":false,\"name\":\"photosService\",\"type\":\"example.module.gallery.service.IGetPhotosService\",\"key\":\"\"},{\"isOpt\":false,\"name\":\"galleryModel\",\"type\":\"example.module.gallery.model.IGalleryModel\",\"key\":\"\"}],\"name\":\"example.module.gallery.controller.LoadPhotosCommand\",\"methods\":[]}"]}};
example_module_gallery_message_GalleryModuleMessage.LOAD_PHOTOS = new hex_event_MessageType("loadPhotos");
...
example_module_gallery_view_GalleryViewHelper.__meta__ = { obj : { 'hex.di.IInjectorContainer' : ["{\"ctor\":{\"args\":[],\"isPre\":false,\"name\":\"new\",\"isPost\":false,\"order\":0},\"props\":[{\"isOpt\":false,\"name\":\"dispatcher\",\"type\":\"hex.event.IDispatcher\",\"key\":\"\"},{\"isOpt\":false,\"name\":\"_model\",\"type\":\"example.module.gallery.model.IGalleryModelRO\",\"key\":\"\"}],\"name\":\"example.module.gallery.view.GalleryViewHelper\",\"methods\":[]}"]}};
...
example_service_flickr_FlickrGetPhotos.__meta__ = { obj : { 'hex.di.IInjectorContainer' : ["{\"ctor\":{\"args\":[],\"isPre\":false,\"name\":\"new\",\"isPost\":false,\"order\":0},\"props\":[],\"name\":\"example.service.flickr.FlickrGetPhotos\",\"methods\":[{\"args\":[],\"isPre\":false,\"name\":\"createConfiguration\",\"isPost\":true,\"order\":0}]}"]}};
